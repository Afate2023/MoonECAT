...
### 背景
Linux Raw Socket 已经从骨架走向可运行路径，但仍需收口为稳定实机闭环。
...
| P0-2 | Linux Raw Socket 实机闭环 | 🔶 | AF_PACKET FFI 完成; send/recv/list 路径已实现; 实机证据待补 |
...
| P0-6 | Native CLI 证据矩阵 | 🔶 | BACKEND_RELEASE_MATRIX.md 有 Windows 实机记录; Linux 待补 |
| **P0 小计** | 6 项 | **1 ✅ / 5 🔶** | |
